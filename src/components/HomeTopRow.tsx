  ...
  return (
    <div className="-mx-4 pl-4 md:pl-0">
        <div className="flex gap-3 sm:justify-center w-full overflow-x-auto">
            <div>
                <button className="size-[92px] bg-gradient-to-tr from-ig-orange to-ig-red text-white rounded-full flex items-center justify-center">
                    <PlusIcon size="42" />
                </button>
                <p className="text-center text-gray-400 text-sm">New Story</p>
            </div>
            {profiles.map(profile => (
                <div className="w-24 flex flex-col justify-center items-center" key={profile.id}>
                    <div>
